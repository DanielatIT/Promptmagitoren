...
export const roleOutputs: { [key in typeof aiRoleOptions[number]]: string } = {
...
export const serpAnalysisPrompt = "Gör en SERP-analys för sökordet [Text input]. Kolla topp 10 organiska resultat på Google (Sverige) just nu för [Text input], sammanfatta vilken information de olika sidorna på top 10 i sökresultaten innehåller, varför de rankar högt (struktur, vilken typ av innehåll, backlinks, lokal SEO, osv.) och vad som saknas som vi kan utnyttja. Ta sedan denna informationen och inkludera i ditt skapande av texten för att ge oss de bästa chanserna att ranka högt. Fokusera på innehåll och inte på det tekniska aspekterna"
